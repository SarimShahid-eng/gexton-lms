<div x-data="{ showcampusForm: false }" class="grid grid-cols-12 gap-4 md:gap-6 p-4">
    ...
    <div class="col-span-12 space-y-6">
        <div
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button @click="showcampusForm = !showcampusForm"
                    ...
                    aria-label="Toggle campus creation form" title="Toggle campus Form">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-5 h-5 transition-transform duration-200"
                        :class="showcampusForm ? 'rotate-45' : ''">
            ...
            <form wire:submit.prevent="save" x-show="showcampusForm" x-cloak
           ...
           dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-400">
                            <option value="" selected>Select Phases</option>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Manage your batches efficiently. You can create, edit, and delete campuses as needed.
                    </p>
                </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-200">
                                ...
                                <td class="py-4 px-3">
                                    <p class="font-semibold text-gray-800 dark:text-white font-['Open_Sans']">
                                        {{ $campus->phase->title ? $campus->phase->title : 'N/A' }}
                                    </p>
                                </td>
                                <td class="py-4 px-3">
                                    <p class="font-semibold text-gray-800 dark:text-white font-['Open_Sans']">
                                    ...
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <div x-data="{ showTooltip: false }" class="relative">
                                            <button wire:click="edit({{ $campus->id }})"
                                                @click="showcampusForm = true" @mouseenter="showTooltip = true"
                                                ...
                                                aria-label="Edit campus {{ $campus->title }}">
                                        ...
                                        {{-- <div x-data="{ showTooltip: false }" class="relative">
                                            <button
                                                ...
                                                aria-label="Delete campus {{ $campus->title }}"
                                            >
                                ...
                                <td colspan="5" class="py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 dark:placeholder-gray-400 font-['Open_Sans']">
                                            Get started by creating your first campuses.
                                        </p>
                                    </div>
                                </td>
                            </tr>
    ...
    <div x-data="{ open: false }" x-init="window.addEventListener('swal-confirm', () => {
        Swal.fire({
            title: 'Are you sure?',
            text: 'Do you really want to delete this campus?',
            icon: 'warning',
...
@push('script')
    <script>
        window.addEventListener('campus-saved', event => {
        ...
        window.addEventListener('campus-deleted', event => {
            const Toast = Swal.mixin({
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
