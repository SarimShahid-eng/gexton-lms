<div x-data="{ showCampusForm: false }" class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12 space-y-6 xl:col-span-12">
        <div
            ...
            <form wire:submit.prevent="save">
                @csrf
                <div x-show="showCampusForm" x-transition:enter="transition ease-out duration-300"
