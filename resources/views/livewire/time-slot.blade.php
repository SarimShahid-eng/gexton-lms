<div x-data="{ showtimeSlotForm: false }" class="grid grid-cols-12 gap-4 md:gap-6 p-4">
    <!-- Create timeSlot Section -->
        ...
        <div
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button @click="showtimeSlotForm = !showtimeSlotForm"
                    ...
                    aria-label="Toggle timeSlot creation form" title="Toggle timeSlot Form">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-5 h-5 transition-transform duration-200"
                        :class="showtimeSlotForm ? 'rotate-45' : ''">
            ...
            <form wire:submit.prevent="save" x-show="showtimeSlotForm" x-cloak
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Manage your timeSlotes efficiently. You can create, edit, and delete timeSlotes as needed.
                    </p>
                </div>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($timeSlots as $timeSlot)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-200">
                                ...
                                <td class="py-4 px-3">
                                    <p class="font-semibold text-gray-800 dark:text-white font-['Open_Sans']">
                                        {{ $timeSlot->description??'not available' }}
                                    </p>
                                </td>
                                ...
                                <td class="py-4 px-3">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <div x-data="{ showTooltip: false }" class="relative">
                                            <button wire:click="edit({{ $timeSlot->id }})"
                                                @click="showtimeSlotForm = true" @mouseenter="showTooltip = true"
                                                ...
                                                aria-label="Edit timeSlot {{ $timeSlot->title }}">
                                        ...
                                        {{-- <x-ui.delete-button method="deletetimeSlot" :payload="$timeSlot->id"
                                            tooltip="Delete timeSlot" :aria-label="'Delete timeSlot ' . $timeSlot->title" confirmTitle="Are you sure?"
                                            confirmText="Do you really want to delete this timeSlot?" /> --}}
                                ...
                                <td colspan="5" class="py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 dark:placeholder-gray-400 font-['Open_Sans']">
                                            Get started by creating your first timeSlot.
                                        </p>
                                    </div>
                                </td>
                            </tr>
...
@push('script')
    <script>
        window.addEventListener('timeSlot-saved', event => {
        ...
        // window.addEventListener('timeSlot-deleted', event => {
        //     const Toast = Swal.mixin({
        //         toast: true,
        //         position: 'top-end',
        //         showConfirmButton: false,
