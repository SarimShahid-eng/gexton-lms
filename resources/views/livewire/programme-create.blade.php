<div x-data="{ showprogrammeForm: false }" class="grid grid-cols-12 gap-4 md:gap-6 p-4">
    ...
    <div class="col-span-12 space-y-6">
        <div
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button @click="showprogrammeForm = !showprogrammeForm"
                    ...
                    aria-label="Toggle programme creation form" title="Toggle programme Form">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-5 h-5 transition-transform duration-200"
                        :class="showprogrammeForm ? 'rotate-45' : ''">
            ...
            <form wire:submit.prevent="save" x-show="showprogrammeForm" x-cloak
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <!-- Label with Icon -->
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2 mb-1.5">
                ...
                <div class="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button wire:loading.attr="disabled" wire:target="save" type="submit"
                        ...
                        <div wire:loading.remove wire:target="save" class="flex items-center gap-2">
                            ...
                            <span>{{ $editMode ? 'Update Programe' : 'Create Programe' }}</span>
                        </div>
                    </button>
                </div>
            </form>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Manage your programmees efficiently. You can create, edit, and delete programmees as needed.
                    </p>
                </div>
                                    ...
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <div x-data="{ showTooltip: false }" class="relative">
                                            <button wire:click="edit({{ $programme->id }})"
                                                @click="showprogrammeForm = true" @mouseenter="showTooltip = true"
                                                ...
                                                aria-label="Edit programme {{ $programme->title }}">
                                        ...
                                        {{-- <div x-data="{ showTooltip: false }" class="relative">
                                            <button
                                                wire:click="confirmDelete({{ $programme->id }})"
                                                ...
                                                aria-label="Delete programme {{ $programme->title }}"
                                            >
    ...
    <div x-data="{ open: false }" x-init="window.addEventListener('swal-confirm', () => {
        Swal.fire({
            title: 'Are you sure?',
            text: 'Do you really want to delete this programme?',
            icon: 'warning',
...
@push('script')
    <script>
        window.addEventListener('programme-saved', event => {
        ...
        window.addEventListener('programme-deleted', event => {
            const Toast = Swal.mixin({
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
