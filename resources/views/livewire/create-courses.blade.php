<div x-data="{ showCourseForm: false }" class="grid grid-cols-12 gap-4 md:gap-6 p-4">
    ...
    <div class="col-span-12 space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800/50 p-4 sm:p-6 shadow-sm">
            <!-- Header Section -->
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button
                    ...
                    aria-label="Toggle course creation form"
                    title="Toggle Course Form"
                >
                    <svg
            ...
            <form wire:submit.prevent="save" x-show="showCourseForm" x-cloak
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Campus Selection -->
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 font-['Open_Sans'] flex items-center">
                        ...
                        @error('campus_id')
                            <p id="campus-error" class="text-red-500 text-sm mt-1 font-['Open_Sans']">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        @error('batch_id')
                            <p id="batch-error" class="text-red-500 text-sm mt-1 font-['Open_Sans']">{{ $message }}</p>
                        @enderror
                    </div>
                </div>
                <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    >
                    @error('title')
                        <p id="title-error" class="text-red-500 text-sm mt-1 font-['Open_Sans']">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-2">
                    ...
                    ></textarea>
                    @error('description')
                        <p id="description-error" class="text-red-500 text-sm mt-1 font-['Open_Sans']">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="w-full overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-800/30">
                        <tr>
                            <th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-600 dark:text-gray-300 font-['Open_Sans']">
                                #
                            </th>
                            <th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-600 dark:text-gray-300 font-['Open_Sans']">
                                Course
                            ...
                            <th scope="col" class="py-3.5 px-3 text-center text-sm font-semibold text-gray-600 dark:text-gray-300 font-['Open_Sans']">
                                Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($courses as $course)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-200">
                                <td class="py-4 px-3">
                                    <span class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center text-sm font-semibold text-blue-600 dark:text-blue-400 font-['Open_Sans']">
                                        {{ $loop->iteration }}
                                    </span>
                                </td>
                                <td class="py-4 px-3">
                            ...
                            <tr>
                                <td colspan="5" class="py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2 font-['Open_Sans']">
                                            No Courses Found
                                        </h3>
