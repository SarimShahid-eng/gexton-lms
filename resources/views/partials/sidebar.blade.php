            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    @role('admin')
                        ...
                        <!-- Menu Item Course -->
                        <li>
                            <a href="{{ route('show_courses') }}" @class([
                                'menu-item',
                                'group',
                                'menu-item-inactive',
                                'menu-item-active' => request()->routeIs('show_courses'),
                            ])
                        ...
                        <!-- Menu Item Campus -->
                        <li>
                            <a href="{{ route('show_campus') }}" @class([
                                'menu-item',
                                'group',
                                'menu-item-inactive',
                                'menu-item-active' => request()->routeIs('show_campus'),
                            ])
                                @click="selected = (selected === 'Calendar' ? '':'Calendar')" class="menu-item group">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <!-- Menu Item Group -->
                        <li>
                            <a href="{{ route('show_batches') }}" @class([
                                'menu-item',
                                'group',
                                'menu-item-inactive',
                                'menu-item-active' => request()->routeIs('show_batches'),
                            ])
                                @click="selected = (selected === 'Calendar' ? '':'Calendar')" class="menu-item group">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <!-- Menu Item Group Students -->
                    @role('teacher')
                        <!-- Menu Item Group Quiz -->
                        <li>
                            <a href="{{ route('teacher.show_quiz') }}" @class([
                                'menu-item',
                                'group',
                                'menu-item-inactive',
                                'menu-item-active' => request()->routeIs('teacher.show_quiz'),
                            ])
                                @click="selected = (selected === 'Calendar' ? '':'Calendar')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <!-- Menu Item Group Questions-->
                    @role('teacher')
                        <li>
                            <a href="{{ route('teacher.show_questions') }}" @class([
                                'menu-item',
                                'group',
                                'menu-item-inactive',
                                'menu-item-active' => request()->routeIs('teacher.show_questions'),
                            ])
                                @click="selected = (selected === 'Calendar' ? '':'Calendar')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    @role('student')
                        {{-- Students role --}}
                        <li>
                            <a href="{{ route('student.show_quiz') }}" @class([
                                'menu-item',
                                'group',
                                'menu-item-inactive',
                                'menu-item-active' => request()->routeIs('student.show_quiz'),
                            ])
                                @click="selected = (selected === 'Calendar' ? '':'Calendar')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
