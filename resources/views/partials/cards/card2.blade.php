<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div class="mt-5 flex items-end justify-between">
            <div>
                <span class="text-sm text-gray-500 dark:text-gray-400">Teachers</span>
               <h4 x-data="countTo({{ (int) ($teachersCount ?? 0) }})" x-init="observeOnce($el)" x-text="display"
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div class="mt-5 flex items-end justify-between">
            <div>
                ...
                <h4 x-data="countTo({{ (int) ($coursesCount ?? 0) }})" x-init="observeOnce($el)" x-text="display"
                    class="mt-2 text-title-sm font-bold text-gray-800 dark:text-white/90">
                </h4>
            </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div class="mt-5 flex items-end justify-between">
            <div>
                ...
                <h4 x-data="countTo({{ (int) ($batchesCount ?? 0) }})" x-init="observeOnce($el)" x-text="display"
                    class="mt-2 text-title-sm font-bold text-gray-800 dark:text-white/90">
                </h4>
            </div>
